 ...
 * 
 * The license is of Apache. This is a modification of the previous double version to biginteger version.
 * @since 1.2
 */
public class ApachePolyNewtonForm implements UnivariateDifferentiableFunction {
     ...
     */
    public ApachePolyNewtonForm(BigInteger a[], double c[])
...
//       return evaluate(a, c, z);
    ...
    public BigInteger valueBigInteger(double z) {
        return evaluate(a, c, z);
    }
